const zero = `
  Un site web.    
  Pour quoi faire?    
  Le monde virtuel des cyberautes est plein de sites utiles et complets.    
...
const two = `
  ...
  Mais je ne cherche pas à être spécial, 
   congosà!    
...
const four = `
  ...
  et que la route que je tente d'établir dans les eaux trompeuses de mon imagination n'a ni de destination précise dans ses hyperliens, 
